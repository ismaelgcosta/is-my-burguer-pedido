# Is My Burguer Pedido [![Quality gate](https://sonarcloud.io/api/project_badges/quality_gate?project=ismaelgcosta_is-my-burguer-pagamento)](https://sonarcloud.io/summary/new_code?id=ismaelgcosta_is-my-burguer-pagamento)
